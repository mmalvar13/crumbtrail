...
//	-----------------------------------------TEST SECTION------------------------------------------------------------
	...
	/**
	 * test getting extra serving by invalid end time
	 * @expectedException \PDOException
	 */
	public function testGetExtraServingByInvalidExtraServingEndTime(){
...
//		think i can use $this->VALID_EXTRASERVINGSTARTTIME1 in here for 2nd param???? what else could i put there for invalid time?
		$extraServing = ExtraServing::getExtraServingByExtraServingEndTime($this->getPDO(), $this->VALID_EXTRASERVINGSTARTTIME1);
	 ...
	 */
	public function testGetAllExtraServing() {
		...
		$results = ExtraServing::getAllExtraServing($this->getPDO());
