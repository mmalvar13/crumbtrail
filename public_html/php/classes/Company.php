...
/**
 * Company class for crumbtrail capstone project
 * 
 * class Company for the Company entity in the crumbtrail application.
 * State variables and constructor and mutators and accessors and PDO methods.
...
class Company implements \JsonSerializable {
	 ...
	 * @param int $newCompanyZip string of the company zip
	 ...
	 * @param int $newCompanyApproved int of the whether the company has been approved by us 0 is no, 1 is yes
	...
	public function __construct(int $newCompanyId = null,
										int $newCompanyAccountCreatorId,
										 ...
										 string $newCompanyActivationToken = null,
	 ...
	 * @return string $companyZip  The value of companyZip.
	 **/
	...
	public function setCompanyDescription(string $newCompanyDescription) {
		...
		if(strlen($newCompanyDescription) > 4096) {
	 ...
	 **/
	public function setCompanyActivationToken(string $newCompanyActivationToken = null) {
		// Base case, for a new company.
